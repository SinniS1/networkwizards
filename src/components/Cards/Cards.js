...
const Cards = () => {
    return (
        <div className='Cards IntroContent'>
            <div className="heading">Hello</div>
            <div className="NetWiz">Sachin</div>
            <div className="para">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores quod ex eveniet ratione unde, molestiae amet blanditiis vitae iusto voluptatum harum a, assumenda, magni tempore cum eligendi. Veniam, magnam optio?
